...
Route::post('attend_lec','Attendance\AttendanceController@attendLecture');
...
Route::post('getTopicsOfQuizzes','Quiz\QuizController@getTopicsOfQuizzes');
Route::post('getQuestionsandAnswersOfQuiz','Quiz\QuizController@showQuizApi');
